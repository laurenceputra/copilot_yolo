...
- stores section entries with an ASCII record separator so subjects containing tabs
  survive render-time deduplication intact
- recognizes conventional-commit bang forms like `feat!:` / `fix!:` before
  falling back to changed-path classification
